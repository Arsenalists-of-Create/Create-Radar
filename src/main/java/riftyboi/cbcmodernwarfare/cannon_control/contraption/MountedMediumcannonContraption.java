...
public class MountedMediumcannonContraption extends AbstractMountedCannonContraption {
    ...
    @Override public rbasamoyai.createbigcannons.cannon_control.cannon_types.ICannonContraptionType getCannonType() { return null; }
