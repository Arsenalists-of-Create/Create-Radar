...
public class Combinations implements Iterable<int[]> {
   ...
   /**
     ...
     * @throws com.happysg.radar.math3.exception.NotPositiveException if {@code n < 0}.
     * @throws com.happysg.radar.math3.exception.NumberIsTooLargeException if {@code k > n}.
     */
