 ...
 *  <ul>
 *   <li>{@link com.happysg.radar.math3.optim}</li>
 *   <li>{@link com.happysg.radar.math3.fitting}</li>
 *  </ul>
 * </h3>
 *
 * <p>
 ...
 * function:
 * <ul>
 *  <li>{@link com.happysg.radar.math3.optimization.univariate.UnivariateOptimizer
 *      UnivariateOptimizer} for {@link com.happysg.radar.math3.analysis.UnivariateFunction
 *      univariate real functions}</li>
 *  <li>{@link com.happysg.radar.math3.optimization.MultivariateOptimizer
 *      MultivariateOptimizer} for {@link com.happysg.radar.math3.analysis.MultivariateFunction
 *      multivariate real functions}</li>
 *  <li>{@link com.happysg.radar.math3.optimization.MultivariateDifferentiableOptimizer
 *      MultivariateDifferentiableOptimizer} for {@link
 *      com.happysg.radar.math3.analysis.differentiation.MultivariateDifferentiableFunction
 *      multivariate differentiable real functions}</li>
 *  <li>{@link com.happysg.radar.math3.optimization.MultivariateDifferentiableVectorOptimizer
 *      MultivariateDifferentiableVectorOptimizer} for {@link
 *      com.happysg.radar.math3.analysis.differentiation.MultivariateDifferentiableVectorFunction
 ...
 * transform a {@link com.happysg.radar.math3.analysis.MultivariateVectorFunction
 * non-differentiable multivariate vectorial function} by converting it to a {@link
 * com.happysg.radar.math3.analysis.MultivariateFunction non-differentiable multivariate
 * real function} thanks to the {@link
 * com.happysg.radar.math3.optimization.LeastSquaresConverter LeastSquaresConverter} helper class.
 * The transformed function can be optimized using any implementation of the {@link
 * com.happysg.radar.math3.optimization.MultivariateOptimizer MultivariateOptimizer} interface.
 * </p>
 *
 * <p>
