 ...
 *  {@link com.happysg.radar.math3.optim.nonlinear.scalar.GoalType#MINIMIZE minimize} or
 *  {@link com.happysg.radar.math3.optim.nonlinear.scalar.GoalType#MAXIMIZE maximize}
 *  a scalar function, called the
 *  {@link com.happysg.radar.math3.optim.nonlinear.scalar.ObjectiveFunction <em>objective
 *  function</em>}.
 *  <br/>
 ...
 *  {@link com.happysg.radar.math3.optim.nonlinear.scalar.gradient} package.
 *  The algorithms that do not need this additional information are located in
 *  the {@link com.happysg.radar.math3.optim.nonlinear.scalar.noderiv} package.
 * </p>
 *
 * <p>
 *  Some problems are solved more efficiently by algorithms that, instead of an
 *  objective function, need access to a
 *  {@link com.happysg.radar.math3.optim.nonlinear.vector.ModelFunction
 *  <em>model function</em>}: such a model predicts a set of values which the
 *  algorithm tries to match with a set of given
 *  {@link com.happysg.radar.math3.optim.nonlinear.vector.Target target values}.
 *  Those algorithms are located in the
 *  {@link com.happysg.radar.math3.optim.nonlinear.vector} package.
 *  <br/>
 *  Algorithms that also require the
 *  {@link com.happysg.radar.math3.optim.nonlinear.vector.ModelFunctionJacobian
 *  Jacobian matrix of the model} are located in the
 *  {@link com.happysg.radar.math3.optim.nonlinear.vector.jacobian} package.
 *  <br/>
 *  The {@link com.happysg.radar.math3.optim.nonlinear.vector.jacobian.AbstractLeastSquaresOptimizer
 ...
 *  {@link com.happysg.radar.math3.optim.nonlinear.scalar.LeastSquaresConverter
 ...
 *  Abstract classes ({@link com.happysg.radar.math3.optim.BaseOptimizer} and
 *  {@link com.happysg.radar.math3.optim.BaseMultivariateOptimizer}) contain
 *  boiler-plate code for storing {@link com.happysg.radar.math3.optim.MaxEval
 *  evaluations} and {@link com.happysg.radar.math3.optim.MaxIter iterations}
 *  counters and a user-defined
 *  {@link com.happysg.radar.math3.optim.ConvergenceChecker convergence checker}.
 * </p>
 *
 * <p>
