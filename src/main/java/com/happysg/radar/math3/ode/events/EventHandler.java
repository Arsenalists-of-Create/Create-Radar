...
package com.happysg.radar.math3.ode.events;
...
public interface EventHandler  {
    ...
    enum Action {
         ...
         * com.happysg.radar.math3.ode.FirstOrderDifferentialEquations#computeDerivatives}
         * method).</p>
         */
        RESET_DERIVATIVES,
   ...
   * otherwise {@link com.happysg.radar.math3.exception.NoBracketingException
   ...
   * com.happysg.radar.math3.ode.FirstOrderDifferentialEquations
   ...
   *   com.happysg.radar.math3.ode.sampling.StepHandler#handleStep handleStep}
   ...
   * com.happysg.radar.math3.ode.sampling.StepHandler StepHandler} method {@link
   * com.happysg.radar.math3.ode.sampling.StepHandler#handleStep(
   * com.happysg.radar.math3.ode.sampling.StepInterpolator, boolean)
   ...
   * com.happysg.radar.math3.ode.sampling.StepNormalizer StepNormalizer}
   * does for example), user code called by this method and user
   * code called by step handlers may experience apparently out of order values
   * of the independent time variable. As an example, if the same user object
   * implements both this {@link EventHandler EventHandler} interface and the
   * {@link com.happysg.radar.math3.ode.sampling.FixedStepHandler FixedStepHandler}
   ...
   * com.happysg.radar.math3.ode.sampling.StepHandler variable step handlers} and
   * to the size of the fixed step for {@link
   * com.happysg.radar.math3.ode.sampling.FixedStepHandler fixed step handlers}.</p>
