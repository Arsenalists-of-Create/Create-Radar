            ...
            if (FastMath.abs(scal) > 1.0e-3) {
                ...
                for (Vector2D[] loop : vertices) {
                    ...
                    while (current < loop.length) {
                        ...
                        final com.happysg.radar.math3.geometry.euclidean.twod.Line line =
                            new com.happysg.radar.math3.geometry.euclidean.twod.Line(pPoint, cPoint, tolerance);
                        ...
                        if (closed || (previous != 1)) {
                            ...
                            final com.happysg.radar.math3.geometry.euclidean.twod.Line l =
                                new com.happysg.radar.math3.geometry.euclidean.twod.Line(pPoint, angle, tolerance);
                        ...
                        if (closed || (current != (loop.length - 1))) {
                            ...
                            final double angle = line.getAngle() + 0.5 * FastMath.PI;
                            final com.happysg.radar.math3.geometry.euclidean.twod.Line l =
                                new com.happysg.radar.math3.geometry.euclidean.twod.Line(cPoint, angle, tolerance);
