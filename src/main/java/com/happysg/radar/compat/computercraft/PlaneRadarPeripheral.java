...
public class PlaneRadarPeripheral implements GenericPeripheral {
    @Override
    public String id() {
        return CreateRadar.asResource("plane_radar").toString();
    }
    ...
    @LuaFunction(mainThread = true)
    public static double getRange(StationaryRadarBlockEntity radarEntity) {
