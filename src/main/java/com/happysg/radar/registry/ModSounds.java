...
public class ModSounds {
    ...
    public static final DeferredHolder<SoundEvent, SoundEvent> RWR_LOCK = register("rwr.lock");
    public static final DeferredHolder<SoundEvent, SoundEvent> RWR_IN_RANGE = register("rwr.in_range");
