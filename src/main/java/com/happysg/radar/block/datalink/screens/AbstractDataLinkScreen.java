...
import com.happysg.radar.networking.packets.RadarLinkConfigurationPayload;
...
public class AbstractDataLinkScreen extends AbstractSimiScreen {
    ...
    public void onClose() {
        ...
        PacketDistributor.sendToServer(new RadarLinkConfigurationPayload(blockEntity.getBlockPos(), sourceData));
    }
