...
@OnlyIn(Dist.CLIENT)
public class RwrEngagedLoopSound extends AbstractTickableSoundInstance {
    private final BlockPos rwrPos;

    public RwrEngagedLoopSound(BlockPos rwrPos, Vec3 soundPos) {
        super(ModSounds.RWR_ENGAGED.get(), SoundSource.BLOCKS, RandomSource.create());
        this.rwrPos = rwrPos;
        this.looping = true;
        this.delay = 0;
        this.volume = 2.0f;
